...
Read this in: [English](#netflix-data-warehouse-elt-pipeline) | [Portuguese](#data-warehouse-netflix-pipeline-elt)
...
The data used in this project was sourced from [Kaggle - Netflix Shows](https://www.kaggle.com/datasets/shivamb/netflix-shows). 

The cleaning process follows the roadmap suggested by the dataset creator in "Netflix Data: Cleaning, Analysis and Visualization".
...
Os dados utilizados neste projeto foram obtidos no [Kaggle - Netflix Shows](https://www.kaggle.com/datasets/shivamb/netflix-shows).

O processo de limpeza segue o roteiro sugerido pelo criador do dataset em "Netflix Data: Cleaning, Analysis and Visualization".
